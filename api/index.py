...
def index():
    ...
    perfil = {
        ...
        'sobre': 'Engenheiro Agrícola especializado em análise de dados e inovação tecnológica. Experiência em projetos de análise geoestatística, automação de processos e desenvolvimento de dashboards. Competente em Python, R, SQL e ferramentas de BI como Power BI e Tableau.',
    ...
    projetos = [
        ...
        },
        {
            ...
            'github': 'https://github.com/Victormartinsilva/victor-portfolio'
        }
    ]
